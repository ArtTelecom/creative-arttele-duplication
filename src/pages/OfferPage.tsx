...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      "При подключении услуг оплата за первый расчётный месяц производится в следующем порядке: если подключение осуществлено с 1-го по 20-е число календарного месяца включительно, Абонент оплачивает полную стоимость выбранного тарифного плана за текущий месяц; если подключение осуществлено после 20-го числа, внесённая сумма зачисляется на лицевой счёт Абонента и учитывается в счёт оплаты услуг следующего расчётного месяца.",
